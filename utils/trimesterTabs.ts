...
export  const trimestersByYear: { label: number; trimestersInfo: Trimester[] }[] = [
    ...
    },
    {
      ...
      trimestersInfo: [
        {
          name: "Trimester 1, 2028",
          code: "283100",
          startDate: new Date("2028-02-14"),
          endDate: new Date("2028-05-07")
        },
        {
          name: "Trimester 2, 2028",
          code: "283200",
          startDate: new Date("2028-05-29"),
          endDate: new Date("2028-08-20")
        },
        {
          name: "Trimester 3, 2028",
          code: "283300",
    ...
    },
    {
      ...
      trimestersInfo: [
        {
          name: "Trimester 1, 2029",
          code: "293100",
          startDate: new Date("2029-02-19"),
          endDate: new Date("2029-05-13")
        },
        {
          name: "Trimester 2, 2029",
          code: "293200",
          startDate: new Date("2029-06-04"),
          endDate: new Date("2029-08-26")
        },
        {
          name: "Trimester 3, 2029",
          code: "293300",
          startDate: new Date("2029-09-17"),
          endDate: new Date("2029-12-09")
        }
      ]
    }
  ];